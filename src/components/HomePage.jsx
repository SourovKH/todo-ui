  ...
  return (
    <div style={{padding: '1em', display: 'flex', alignItems: "center", justifyContent: 'center', height: '90%'}}>
      <TemplateBox>
        ...
        <DashBoardButton>
          <Link to="/todo-dashboard" style={{textDecoration: 'none', color: 'black'}}>Get Started</Link>
        </DashBoardButton>
      </TemplateBox>
      <HomePageImage>
        <img src="../../public/images/home-page-image.jpeg" style={{height: '90%', aspectRatio: '1'}}></img>
      </HomePageImage>
  </div>
  )
}
